...
<main id="primary" class="site-main">
	...
	<div id="about" class="w-full inline-block">
		<div class="section">
			<h1><span>About</span></h1>
			<div class="grid grid-cols-1 md:grid-cols-12 gap-x-4">
				<div class="mb-12 md:mb-0 md:col-span-5">
					...
					<div class="grid" style="grid-template-columns: min-content auto;">
						...
						<div>
							...
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
									<div class="rounded h-full" style="width: 80%; background-color: <?php echo $primary_color ?>"></div>
								</div>
							</div>
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
							...
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
									<div class="rounded h-full" style="width: 50%; background-color: <?php echo $primary_color ?>"></div>
								</div>
							</div>
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
									<div class="rounded h-full" style="width: 70%; background-color: <?php echo $primary_color ?>"></div>
								</div>
							</div>
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
							...
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
									<div class="rounded h-full" style="width: 60%; background-color: <?php echo $primary_color ?>"></div>
								</div>
							</div>
							<div class="flex items-center" style="padding: 9px 0;">
								<div class="rounded inline-block w-full h-2.5" style="background-color: #D9D9D9;">
	...
	<div id="projects" class="bg-gray-50 w-full inline-block">
		<div class="section">
			...
			<?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
				...
				<div class="project grid grid-cols-1 md:grid-cols-12 gap-x-4 grid-flow-dense items-center">
					<div class="mb-12 md:mb-0 <?php echo $is_even_index ? 'md:col-span-5' : 'md:col-start-7 md:col-span-6' ?>">
	...
	<div id="experience" class="w-full inline-block">
		<div class="section">
			<h1><span>Experience</span></h1>
			<div class="grid gap-x-4 grid-cols-1 md:grid-cols-12">
				<div class="mb-12 md:mb-0 flex md:col-span-5 lg:col-span-4">
	...
	<div id="contact" class="bg-gray-50 w-full inline-block">
		<div class="section">
