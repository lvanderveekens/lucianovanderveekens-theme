...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$lucianovanderveekens_theme_description = get_bloginfo( 'description', 'display' );
			if ( $lucianovanderveekens_theme_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $lucianovanderveekens_theme_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
